...
@Controller("/pcticket/group")
@RequestMapping("/pcticket/group")
public class GroupController extends BaseController {
            ...
            for (GroupDto groupDto : list) {
                ...
                if (!productDtos.isEmpty()) {
                    for (ProductDto productDto : productDtos) {
                        ...
                        productDto.setTicketUrl(url + "/pcticket/index/getProductById?ticketId=" + productDto.getId() + "&userId=" + currentUser.getId());
                    }
                }
                groupDto.setGroupUrl(url + "/pcticket/index/getProductById?groupId=" + groupDto.getId() + "&userId=" + currentUser.getId());
            }
            model.addAttribute("shopUrl", url + "/pcticket/index/index?userId=" + currentUser.getId());
        }
        model.addAttribute("dto", dto);
        model.addAttribute("pDto", pDto);
        model.addAttribute("page", restResponse.getData());
        return "/pcshop/ticket/group/list";
    }

    @RequestMapping(value = "/add")
    public String add() {
        return "/pcshop/ticket/group/add";
    }
    ...
    public String edit(Long id, ModelMap model) {
        ...
        return "/pcshop/ticket/group/edit";
    }
