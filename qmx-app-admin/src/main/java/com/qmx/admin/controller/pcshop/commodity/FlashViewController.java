...
@Controller("/pccommodity/flashview")
@RequestMapping("/pccommodity/flashview")
public class FlashViewController extends BaseController {
    ...
    public String list(FlashViewDto dto, ModelMap model) {
        ...
        dto.setCarouselType(CarouselTypeEnum.Shop);
        ...
        return "/pcshop/commodity/flashview/list";
    }

    @RequestMapping(value = "/add")
    public String add() {
        return "/pcshop/commodity/flashview/add";
    }
    ...
    public String edit(Long id, ModelMap model) {
        ...
        return "/pcshop/commodity/flashview/edit";
    }
