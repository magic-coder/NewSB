...
public class ProductController extends BaseController {
    ...
    public String getProducts(SysTicketsVO dto, Long groupId, ModelMap model) {
        ...
        if (null != list && !list.isEmpty()) {
            Iterator<SysTicketsDTO> iter = list.iterator();
            while (iter.hasNext()) {
                SysTicketsDTO sysTicketsDTO = iter.next();
        ...
        return "/shop/ticket/product/productlist";
    }
    ...
    public String save(ProductDto dto, RedirectAttributes redirectAttributes, HttpServletRequest request) {
        ...
        return "redirect:/ticket/group/list.jhtml";
    }
    ...
    public String edit(Long id, ModelMap model) {
        ...
        return "/shop/ticket/product/edit";
    }
