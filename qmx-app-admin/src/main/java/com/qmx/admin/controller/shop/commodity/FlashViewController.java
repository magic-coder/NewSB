...
@Controller("/commodity/flashview")
@RequestMapping("/commodity/flashview")
public class FlashViewController extends BaseController {
    ...
    public String list(FlashViewDto dto, ModelMap model) {
        ...
        return "/shop/commodity/flashview/list";
    }

    @RequestMapping(value = "/add")
    public String add() {
        return "/shop/commodity/flashview/add";
    }
    ...
    public String edit(Long id, ModelMap model) {
        ...
        return "/shop/commodity/flashview/edit";
    }
