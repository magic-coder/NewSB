...
@Controller("/ticket/flashview")
@RequestMapping("/ticket/flashview")
public class FlashViewController extends BaseController {
    ...
    public String list(FlashViewDto dto, ModelMap model) {
        ...
        return "/shop/ticket/flashview/list";
    }

    @RequestMapping(value = "/add")
    public String add() {
        return "/shop/ticket/flashview/add";
    }
    ...
    public String edit(Long id, ModelMap model) {
        ...
        return "/shop/ticket/flashview/edit";
    }
