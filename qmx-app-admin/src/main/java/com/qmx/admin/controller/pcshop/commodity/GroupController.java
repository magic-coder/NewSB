 ...
 * @Date: 2018/1/8  11:01
 */
@Controller("/pccommodity/group")
@RequestMapping("/pccommodity/group")
public class GroupController extends BaseController {
    ...
    public String list(GroupDto dto, ModelMap modelMap, HttpServletRequest request) {
        ...
        if (!restResponse.getData().getRecords().isEmpty()) {
            //商城链接
            modelMap.addAttribute("shopUrl", url + "/pccommodity/index/getIndex?userId=" + pageDto.getRecords().get(0).getMemberId());
            for (GroupDto groupDto : pageDto.getRecords()) {
                //组链接
                groupDto.setGroupUrl(url + "/pccommodity/index/getProductById?groupId=" + groupDto.getId() + "&userId=" + groupDto.getMemberId());
                if (!groupDto.getReleaseDtos().isEmpty()) {
                    //商品链接
                    for (ReleaseDto releaseDto : groupDto.getReleaseDtos()) {
                        releaseDto.setReleaseUrl(url + "/pccommodity/index/getProductById?releaseId=" + releaseDto.getId() + "&userId=" + releaseDto.getMemberId());
                    }
                }
            }
        }
        ...
        return "/pcshop/commodity/group/list";
    }
    ...
    public String add() {
        return "/pcshop/commodity/group/add";
    }
    ...
    public String edit(Long id, ModelMap ModelMap) {
        ...
        return "/pcshop/commodity/group/edit";
    }
