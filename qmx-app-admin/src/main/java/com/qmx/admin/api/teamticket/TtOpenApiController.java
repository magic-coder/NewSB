package com.qmx.admin.api.teamticket;
...
import com.qmx.admin.remoteapi.teamticket.TtOpenApiRemoteService;
...
@RestController
@RequestMapping("/open/teamticket")
public class TtOpenApiController extends BaseOpenController {
    ...
    @Autowired
    private TtOpenApiRemoteService openApiRemoteService;
    ...
    public RestResponse<List<TtOrderDto>> getOrderList(HttpServletRequest request) {
        String appkey = request.getParameter("appkey");
        SysUserApiDTO userApiDTO = sysUserApiRemoteService.findByAppkey(appkey).getData();
        SysUserDto sysUserDto = sysUserRemoteService.findById(userApiDTO.getUserId()).getData();

        RestResponse<List<TtOrderDto>> result = openApiRemoteService.getOrderList(sysUserDto.getId());
    ...
    public RestResponse<Object> updateStatus(HttpServletRequest request) {
        ...
        RestResponse<Object> result = openApiRemoteService.updateStatus(type, ids);
