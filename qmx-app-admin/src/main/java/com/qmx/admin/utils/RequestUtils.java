...
public class RequestUtils {
    ...
    public static BigDecimal[] getBigDecimalAll(HttpServletRequest request,
                                                String name) {
        String[] temps = request.getParameterValues(name);
        if (temps == null) {
        ...
        try {
            ...
            for (Map.Entry<String, String[]> entry : map.entrySet()) {
                ...
                if (key.endsWith(suffix)) {
                    String tmpkey = StringUtils
                            .substringBeforeLast(key, suffix);
                        ...
                        for (int vi = 0; vi < value.length; vi++) {
                            ...
                            for (int i = 1; i < keyArray.length; i++) {
                                ...
                                if (i == keyArray.length - 1) {
                                    maps[i].put(keyArray[i],
                                            StringUtils.join(value, PARAM_SEP));
                                }
                            }
    ...
    public static Map<String, String> getRequestMap(HttpServletRequest request) {
        ...
        while (names.hasMoreElements()) {
            ...
            map.put(name, StringUtils.join(request.getParameterValues(name),
                    PARAM_SEP));
        }
        return map;
    }
    ...
    private static final String[] mobileAgents = {"iphone", "android", "phone", "mobile",
