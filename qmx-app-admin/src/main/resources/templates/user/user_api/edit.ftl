...
<form id="inputForm" action="update" method="post">
    ...
    <table class="input tabContent">
        <tr>
            ...
            <td>
                ...
                <#list orderSources as a>
                    <option value="${a.id!}" <#if dto.orderSourceId = a.id>selected</#if> >${a.remark!}-${a.name!}</option>
                </#list>
                </select>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <#list payMethods as a>
                    <option value="${a!}" <#if dto.payMethod?? && dto.payMethod == a>selected</#if>>${a.getName()!}</option>
                </#list>
                </select>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="clientId" value="${dto.clientId!}" style="width: 300px;" class="text" maxlength="20" />
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="text" name="appKey" value="${dto.appKey!}" style="width: 300px;" class="text" maxlength="20" />
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="text" name="secretKey" value="${dto.secretKey!}" style="width: 300px;" class="text" maxlength="20" />
            </td>
        </tr>
        <tr>
            <th>
        ...
        <tr>
            ...
            <td>
                <input type="text" style="width: 90%;" value="${dto.consumeNotifyUrl!}" class="text" name="consumeNotifyUrl" />
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="text" class="text" value="${dto.refundNotifyUrl!}" style="width: 90%;" name="refundNotifyUrl"/>
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="text" class="text" value="${dto.sendCodeNotifyUrl!}" style="width: 90%;" name="sendCodeNotifyUrl"/>
            </td>
        </tr>
        <tr>
            <th>
