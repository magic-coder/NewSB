...
$().ready(function() {
    ...
    $("#distributorName").dropqtable({
        ...
        tableoptions: {
            //autoload: true,
            url: "../distributor/listForJson", //查询响应的地址
	...
	<form id="inputForm" action="save" method="post">
		...
		<table class="input tabContent">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="clientId" style="width: 300px;" class="text" maxlength="20" />
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    <input type="text" name="appKey" style="width: 300px;" class="text" maxlength="20" />
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    <input type="text" name="secretKey" style="width: 300px;" class="text" maxlength="20" />
                </td>
            </tr>
			<tr>
				<th>
