    ...
    <div class="layui-form-item" style="margin-top: 20px;">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                ...
                <input name="supplierFlag" type="hidden" value="${userInfo.supplierFlag?string("true","false")}"/>
...
<#if currentMember.userType == 'admin'>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <label class="layui-form-label">${userInfo.userType.getName()}</label>
            </div>
        </div>
    </div>
</#if>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <#if userInfo.supplierFlag?? && userInfo.supplierFlag>
