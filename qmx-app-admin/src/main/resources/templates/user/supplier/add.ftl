...
<#if currentMember.userType == 'admin'>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <label><input type="radio" name="userType" value="group_supplier" title="集团"/></label>
                <label><input type="radio" name="userType" checked value="supplier" title="普通"/></label>
            </div>
        </div>
    </div>
</#if>
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">特殊供应商</label>
            <div class="layui-input-inline">
                <label><input type="radio" name="supplierFlag" value="true" title="是"/></label>
                <label><input type="radio" name="supplierFlag" checked value="false" title="否"/></label>
            </div>
        </div>
    </div>
    <div class="layui-form-item">
