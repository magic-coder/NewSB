...
<form id="inputForm" action="update" method="post">
    ...
    <#if currentMember.userType == 'admin'>
        ...
        <tr>
            ...
            <td>
                <label><input type="radio" <#if userInfo.supplierFlag?? && userInfo.supplierFlag>checked</#if> name="supplierFlag" value="true"/>是</label>
                <label><input type="radio" <#if (!userInfo.supplierFlag?? || !userInfo.supplierFlag)>checked</#if> name="supplierFlag" value="false"/>否</label>
            </td>
        </tr>
        <tr>
            <th>
