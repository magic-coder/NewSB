...
<form id="inputForm" action="doModifyUserEmailVerify" method="post" autocomplete="off">
<div class="gds-pull-index">
    <div class="gds-half-box" style="min-width: 760px;">
        ...
        <div class="gds-form gds-form-change">
            ...
            <div class="row">
                <label class="col-xs-6">新邮箱：</label>
                <input type="text" name="email" type="text" class="col-xs-8" placeholder="请输入新邮箱" />
            </div>
            <div class="row">
                <label class="col-xs-6">邮箱验证码：</label>
                <input type="text" name="verifyCode" type="text" class="col-xs-8" placeholder="新邮箱收到的验证码" />
                <div class="col-xs-6">
                    <span id="sendCaptcha" class="gds-btn-3">发送验证码</span>
                </div>
            </div>
            <div id="emailPwd" class="row" style="display: none">
                <label class="col-xs-6">邮箱密码：</label>
            ...
            <div class="row">
                ...
                <label><input name="updateAll" type="checkbox" value="true"/>将原邮箱关联所有账号修改至当前邮箱</label>
            </div>
            <div class="row">
