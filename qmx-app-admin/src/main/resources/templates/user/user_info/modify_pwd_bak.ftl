    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#sendCaptcha").click(function () {
                ...
                $.ajax({
                    url: '/login/sendModifyPwdEmailVerifyCode',
                    type: 'POST',
                    data:data,
...
<form id="inputForm" action="doModifyUserPwd" method="post">
    <br/>
    <p>修改密码</p>
    <table class="input">
        <tr>
        ...
        <tr>
            ...
            <td>
                <input type="password" name="currPwd" class="text" maxlength="200" />
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="password" name="newPwd" class="text" maxlength="200" />
            </td>
        </tr>
        <tr>
            <th>
