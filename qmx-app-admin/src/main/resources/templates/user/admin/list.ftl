...
<@shiro.hasPermission name = "admin:addAdmin">
<div class="layui-form-item" style="margin-left: 10px;">
    <a href="add" id="addAdmin" class="layui-btn">添加管理员</a>
</div>
</@shiro.hasPermission>
<table id="listTable" class="layui-table">
    ...
    <tr>
        ...
        <td>
            <@shiro.hasPermission name = "admin:updateAdmin">
            <a id="editAdmin" href="edit?id=${dto.id}"/>[编辑]</a>
            </@shiro.hasPermission>
            <@shiro.hasPermission name = "admin:deleteAdmin">
            <a class="del" url="delete?id=${dto.id}">[删除]</a>
            </@shiro.hasPermission>
            <@shiro.hasPermission name = "admin:editAdminPermission">
