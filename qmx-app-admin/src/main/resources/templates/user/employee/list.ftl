...
<@shiro.hasPermission name = "admin:addEmployee">
<div class="layui-form-item" style="margin-left: 10px;">
    <a href="add" class="layui-btn">添加员工</a>
</div>
</@shiro.hasPermission>
<table id="listTable" class="layui-table">
    ...
    <tr>
        ...
        <td>
            <@shiro.hasPermission name = "admin:updateEmployee">
                <a id="editAdmin" href="edit?id=${dto.id}"/>[编辑]</a>
            </@shiro.hasPermission>
            <@shiro.hasPermission name = "admin:deleteEmployee">
                <a class="del" url="delete?id=${dto.id}">[删除]</a>
            </@shiro.hasPermission>
            <@shiro.hasPermission name = "admin:editEmployeePermission">
