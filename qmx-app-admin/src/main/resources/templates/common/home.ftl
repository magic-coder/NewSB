                ...
                <div class="gds-welcome-cell col-xs-10">
                    <div class="gds-section">
                        ...
                        <div class="gds-section-body">
                            ...
                            <p class="gds-section-row">手机号：${homeUserInfo.phone!}</p>
                    ...
                    <div class="gds-welcome-cell col-xs-10">
                        <div class="gds-section">
                            ...
                            <div class="gds-section-body">
                                ...
                                <p class="gds-section-row">短信计费方式：${(userChargeInfo.normalSmsCharge)!0.00}元/条<span>（说明：每${(userChargeInfo.normalSmsWordsCount)!70}字为一条）</span></p>
                            </div>
                        </div>
                    </div>
                    <div class="gds-welcome-cell col-xs-10">
