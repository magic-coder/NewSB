...
<@shiro.hasPermission name = "admin:addSupplierSmsTemplate">
<div class="layui-form-item" style="margin-left: 10px;">
    <a href="add" class="layui-btn">短信模板授权</a>
</div>
</@shiro.hasPermission>
<table id="listTable" class="layui-table">
    ...
    <tr>
        ...
        <td>
            <@shiro.hasPermission name = "admin:deleteSupplierSmsTemplate">
                <a href="delete?id=${warehouse.authTemplateId}">[删除]</a>
            </@shiro.hasPermission>
        </td>
    </tr>
    </#list>
