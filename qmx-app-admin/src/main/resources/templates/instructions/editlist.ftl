...
<form class="layui-form" action="editlist" method="post">
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            <div class="layui-input-inline">
                ...
                <button type="reset" onclick="location.href='editlist';" class="layui-btn layui-btn-primary">重置</button>
            </div>
        </div>
    </div>
</form>
...
<div class="layui-form-item">
    <div class="layui-inline">
        <div class="layui-input-inline">
            <button onclick="location.href='add';" class="layui-btn layui-btn-normal" style="
    margin-left: 100px;">新增</button>
        </div>
    </div>
</div>
...
<#list page.records as dto>
    <tr>
        ...
        <td>
            <input type="button" onclick="location.href='getdetails?detailsId=${dto.detailsId!?c}';"
                   class="layui-btn layui-btn-normal layui-btn-sm" data-id="${dto.detailsId!?c}" id="viewBtn"
                   value="查看"/>
            <input type="button" onclick="location.href='editor?id=${dto.id!?c}'+'&detailsId=${dto.detailsId!?c}'"
                   class="layui-btn layui-btn-normal layui-btn-sm" data-id="${dto.detailsId!?c}" id="viewBtn"
                   value="编辑"/>
