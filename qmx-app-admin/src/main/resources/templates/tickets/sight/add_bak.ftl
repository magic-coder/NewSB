	...
	<form id="inputForm" action="save.jhtml" method="post">
		<table class="input">
			<tr>
				...
				<td>
					<input type="text" name="sightName" class="text" maxlength="300" style="width: 300px;" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="longitude" class="text" maxlength="50" />
					<button onclick="lookMap(0,0)" type="button" class="button">标注</button>
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="latitude" class="text" maxlength="50" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="bizHours" class="text" maxlength="50" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="orderPhone" class="text" value="" maxlength="30" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="consultPhone" class="text" value="" maxlength="30" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<textarea name="description" class="text editor"></textarea>
				</td>
			</tr>
