...
<form id="inputForm" action="saveTicketsType" method="post">
    <ul id="tab" class="tab">
        <li>
    ...
    <table class="input tabContent">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="name" class="text" maxlength="30" style="width:300px;"/>&nbsp;<span
            ...
            <td>
                <#if currentMember.userType == 'supplier'>
                    ...
                    <#if currentMember.specialSupplier?? && currentMember.specialSupplier>
                        <br/><input id="supplier2Name" type="text" class="text" readonly maxlength="300"/>
                ...
                <#elseif currentMember.userType == 'admin'>
                    ...
                    <input id="supplierId" name="supplierId" type="hidden"/><br/>
