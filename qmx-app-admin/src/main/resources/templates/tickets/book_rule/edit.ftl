        ...
        <tr>
            ...
            <td class="needPassengerInfoCheckTd">
                ...
                <#if dto.needPassengerInfo??>
                    ...
                    <br/>
                    <label><input type="checkbox" name="needPassengerInfoOther_Check" dest="input[name=needPassengerInfoOther1]"<#if dto.needPassengerInfoOther1??> ${disabledFlag!}</#if> disabled /><input type="text" name="needPassengerInfoOther1" class="text" placeholder="其他1" value="${dto.needPassengerInfoOther1!}" style="width: 80px;" ${disabledFlag!} /></label>
                    <label><input type="checkbox" name="needPassengerInfoOther_Check" dest="input[name=needPassengerInfoOther2]"<#if dto.needPassengerInfoOther2??> ${disabledFlag!}</#if> disabled /><input type="text" name="needPassengerInfoOther2" class="text" placeholder="其他2" value="${dto.needPassengerInfoOther2!}" style="width: 80px;" ${disabledFlag!} /></label>
