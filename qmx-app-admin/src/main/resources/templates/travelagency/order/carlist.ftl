...
<#include "/include/common_header_include.ftl">
    <script>
        ...
        function addProductItem(data) {
            var repeat = false;
            parent.$("#carTable input.carId").each(function () {
                var tmp = $(this).val();
                if (tmp == data.id) {
                    repeat = true;
                    return false;
...
<body>
<hr/>
<form class="layui-form" action="getCar" method="post">
    <input type="hidden" name="type" value="${dto.type!}"/>
    <input type="hidden" name="distributorId" value="${dto.distributorId!}"/>
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">车牌号</label>
            <div class="layui-input-inline">
                <input type="text" name="carNumber" value="${dto.carNumber!}" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
            <div class="layui-input-inline">
                ...
                <button type="reset" onclick="location.href='getCar?distributorId=${dto.distributorId!}';"
