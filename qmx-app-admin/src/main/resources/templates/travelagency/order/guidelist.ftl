...
<#include "/include/common_header_include.ftl">
    <script>
        ...
        function addProductItem(data) {
            var repeat = false;
            parent.$("#guideTable input.guideId").each(function () {
                var tmp = $(this).val();
                if (tmp == data.id) {
                    repeat = true;
                    return false;
            ...
            var $tr = '<tr>' +
                    '<td><input type="hidden" name="guideId" class="guideId" value="' + data.id + '"/>' + data.name + '</td>' +
                    '<td><input type="button" class="layui-btn layui-btn-sm layui-btn-normal deleteItem" data-id="" value="删除"/></td>' +
                    '</tr>';
            parent.$('#guideTable').append($tr);
        }
    </script>
    <script>
...
<body>
<hr/>
<form class="layui-form" action="getGuide" method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            <div class="layui-input-inline">
                ...
                <button type="reset" onclick="location.href='getGuide?distributorId=${dto.distributorId!}';"
