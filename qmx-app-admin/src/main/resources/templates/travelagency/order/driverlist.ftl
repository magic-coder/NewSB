...
<#include "/include/common_header_include.ftl">
    <script>
        ...
        function addProductItem(data) {
            var repeat = false;
            parent.$("#driverTable input.driverId").each(function () {
                var tmp = $(this).val();
                if (tmp == data.id) {
                    repeat = true;
                    return false;
            ...
            var $tr = '<tr>' +
                    '<td><input type="hidden" name="driverId" class="driverId" value="' + data.id + '"/>' + data.name + '</td>' +
                    '<td><input type="button" class="layui-btn layui-btn-sm layui-btn-normal deleteItem" data-id="" value="删除"/></td>' +
                    '</tr>';
            parent.$('#driverTable').append($tr);
        }
    </script>
    <script>
...
<body>
<hr/>
<form class="layui-form" action="getDriver" method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            <div class="layui-input-inline">
                ...
                <button type="reset" onclick="location.href='getDriver?distributorId=${dto.distributorId!}';"
