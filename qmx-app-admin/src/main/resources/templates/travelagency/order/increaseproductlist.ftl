...
<#include "/include/common_header_include.ftl">
    <script>
        ...
        function addProductItem(data) {
            var repeat = false;
            parent.$("#increaseProductTable input.increaseProductId").each(function () {
                var tmp = $(this).val();
                if (tmp == data.id) {
                    repeat = true;
                    return false;
            ...
            $.ajax({
                ...
                type: "POST",
                async: false,
                data: {increaseProductId: data.id, agreementId: agreementId},
                success: function (json) {
                    var $tr = '<tr>' +
                            '<td><input type="hidden" name="increaseProductId" class="increaseProductId" value="' + data.id + '"/><labeld title="' + title + '">' + data.name + '</label></td>' +
                            '<td><input type="hidden" name="inPrice" value="" class="layui-input"/><labeld class="inPrice"></labeld></td>' +
                            '<td><input name="inQuantity" value="" lay-verify="required" class="layui-input"/></td>' +
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            <div class="layui-input-inline">
                ...
                <button type="reset" onclick="location.href='getIncreaseProducts?agreementId=${dto.agreementId!}';"
