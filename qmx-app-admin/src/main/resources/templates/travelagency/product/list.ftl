...
<@shiro.hasPermission name="admin:taProductCreate">
...
<table class="layui-table" style="width:98%;margin-left: 10px;margin-top: 10px;margin-right: 10px;" id="listTable"
    ...
    ${dto.surplusDayStock!}
        ...
        <td>
            <@shiro.hasPermission name="admin:taProductEdit">
            ...
            <@shiro.hasPermission name="admin:taProductDelete">
