        ...
        <div class="layui-inline">
            <div class="layui-input-inline">
                <input type="text" name="name" value="${dto.name!}" autocomplete="off"
                       class="layui-input" placeholder="旅行社名称">
            </div>
        </div>
        <div class="layui-inline">
            <div class="layui-input-inline">
                <input type="text" name="managerName" value="${dto.managerName!}" autocomplete="off"
                       class="layui-input" placeholder="客户经理">
            </div>
        </div>
        <div class="layui-inline">
            <div class="layui-input-inline">
                <input type="text" name="userName" value="${dto.userName!}" autocomplete="off"
                       class="layui-input" placeholder="分销商">
            </div>
        </div>
    <@shiro.hasPermission name="admin:tyquerySupplier">
        <div class="layui-inline">
            <div class="layui-input-inline">
...
<@shiro.hasPermission name="admin:createTravelAgency">
...
<table class="layui-table" style="width:98%;margin-left: 10px;margin-top: 10px;margin-right: 10px;" id="listTable"
    ...
    <tr>
        ...
        <td>
            <@shiro.hasPermission name="admin:editTravelAgency">
            ...
            <@shiro.hasPermission name="admin:deleteTravelAgency">
