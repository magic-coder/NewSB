    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="width: auto;">
                ...
                <div id="userIdName" class="layui-form-mid"></div>
            </div>
        ...
        <#if manager??>
            <div class="layui-input-inline" style="width: auto;">
                <input id="manager" name="manager" type="hidden" lay-verify="required" autocomplete="off"
                       class="layui-input" value="${manager.id!}">
                <div id="managerName" class="layui-form-mid">${manager.account!}</div>
            </div>
            <@shiro.hasPermission name="admin:tyselectEmployee">
                <div class="layui-input-inline">
        ...
        <#else >
            <div class="layui-input-inline" style="width: auto;">
                <input id="manager" name="manager" type="hidden" lay-verify="required" autocomplete="off"
                       class="layui-input" value="">
                <div id="managerName" class="layui-form-mid"></div>
            </div>
            <div class="layui-input-inline">
                <button id="managerBtn" type="button" class="layui-btn">
                    选择
