...
<@shiro.hasPermission name="admin:taInProductCreate">
...
<table class="layui-table" style="width:98%;margin-left: 10px;margin-top: 10px;margin-right: 10px;" id="listTable"
    ...
    <tr>
        ...
        <td>
            <@shiro.hasPermission name="admin:taInProductEdit">
            ...
            <@shiro.hasPermission name="admin:taInProductDelete">
