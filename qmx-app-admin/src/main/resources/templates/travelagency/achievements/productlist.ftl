...
<#include "/include/common_header_include.ftl">
    <script>
        ...
        function addProductItem(data) {
            ...
            var $tr = '<tr>' +
                    '<td>' + data.name + '<input type="hidden" name="productIds" class="productId" value="' + data.id + '"/></td>' +
                    '<td><select name="types"><option value="money">金额</option><option value="amount">数量</option></select></td>' +
                    '<td><input name="numbers" value="" lay-verify="required|deduct" class="layui-input"/></td>' +
                    '<td>' +
                    '<input type="button" class="layui-btn layui-btn-sm deleteItem" data-id="' + data.id + '" value="删除"/>' +
                    '</td>' +
                    '</tr>';
