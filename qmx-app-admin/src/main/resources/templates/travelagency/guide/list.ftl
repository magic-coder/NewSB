...
<form class="layui-form" action="list" method="post">
    ...
    <@shiro.hasPermission name="admin:taGuideqd">
        <div class="layui-inline">
            <div class="layui-input-inline">
    ...
    <@shiro.hasPermission name="admin:taGuideqs">
        <div class="layui-inline">
            <div class="layui-input-inline">
...
<@shiro.hasPermission name="admin:taGuideCreate">
...
<table class="layui-table" style="width:98%;margin-left: 10px;margin-top: 10px;margin-right: 10px;" id="listTable"
    ...
    <tr>
        ...
        <td>
            <@shiro.hasPermission name="admin:taGuideEdit">
            ...
            <@shiro.hasPermission name="admin:taGuideDelete">
