...
<form class="layui-form" action="list" method="post">
        ...
        <div class="layui-inline">
            <div class="layui-input-inline">
                <input type="text" name="carNumber" value="${dto.carNumber!}" autocomplete="off"
                       class="layui-input" placeholder="车牌号">
            </div>
        </div>
    <@shiro.hasPermission name="admin:taCarqd">
        <div class="layui-inline">
            <div class="layui-input-inline">
    ...
    <@shiro.hasPermission name="admin:taCarqs">
        <div class="layui-inline">
            <div class="layui-input-inline">
...
<table class="layui-table" style="width:98%;margin-left: 10px;margin-top: 10px;margin-right: 10px;" id="listTable"
    ...
    <tr>
        ...
        <td>
            <@shiro.hasPermission name="admin:taCarEdit">
            ...
            <@shiro.hasPermission name="admin:taCarDelete">
