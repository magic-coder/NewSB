...
<form class="layui-form" id="inputForm">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="hidden" id="productId" name="product" value="${dto.product!}" lay-verify="required"/>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input id="price" name="price" value="${dto.price!}" lay-verify="required" autocomplete="off" class="layui-input"/>
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input id="totleNumber" name="totleNumber" value="${dto.totleNumber!}" lay-verify="required" autocomplete="off" class="layui-input"/>
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input id="beginDate" name="beginDate" value="${dto.beginDate!?string("yyyy-MM-dd")}" lay-verify="required" autocomplete="off" class="layui-input">
        </div>
