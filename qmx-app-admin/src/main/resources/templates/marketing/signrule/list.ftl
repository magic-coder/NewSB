...
<@shiro.hasPermission name = "wxsign:add">
...
<table class="layui-table" style="width:98%;margin-left: 10px;margin-top: 10px;margin-right: 10px;" id="sysBalanceTable"
    ...
    <tr>
        ...
        <td>
            ${(dto.endDate)?string('yyyy-MM-dd HH:mm:ss')} — ${(dto.endDate)?string('yyyy-MM-dd HH:mm:ss')}
        </td>
        <td>
            <@shiro.hasPermission name = "wxsign:edit">
            ...
            <@shiro.hasPermission name = "wxsign:delete">
