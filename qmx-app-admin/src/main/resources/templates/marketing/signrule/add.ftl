...
<form id="inputForm" class="layui-form" action="save" method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 400px;">
            <input id="signName" name="signName" lay-verify="required" style="width: 190px;display: inline;" autocomplete="off" class="layui-input" readonly>
            <input type="hidden" id="signActivity" name="signActivity"/>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 400px;">
            <input id="prizeName" name="prizeName" lay-verify="required" style="width: 190px;display: inline;" autocomplete="off" class="layui-input" readonly>
            <input type="hidden" id="signPrize" name="signPrize"/>
    ...
    <div class="layui-form-item">
        <div class="layui-inline" style="width: 50%;">
            ...
            <div class="layui-input-inline" style="width:50%;">
                <input name="signType" value="LIANXU" title="连续签到" checked type="radio">
                <input name="signType" value="LEIJI" title="累计签到" type="radio">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input id="signNum" name="signNum" lay-verify="required|number" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
