...
<#include "/include/common_header_include.ftl">
    ...
    <script>
        ...
        $(document).on("click", "#submitIframe", function () {
            ...
            parent.$("#signPrize").val($checkedId.val());
            parent.$("#prizeName").val($checkedId.parents("tr:eq(0)").find("td:eq(1)").text());
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            <div class="layui-input-inline">
                ...
                <button type="reset" onclick="location.href='prizeList';" class="layui-btn layui-btn-primary">重置
                </button>
            </div>
        </div>
    </div>
