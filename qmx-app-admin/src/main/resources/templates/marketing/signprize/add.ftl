...
<form class="layui-form" action="save" method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input name="amount" lay-verify="required|number" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">奖品权重</label>
        <div class="layui-input-inline">
            <input name="weight" lay-verify="required|number" autocomplete="off" class="layui-input">
        </div>
    </div>
