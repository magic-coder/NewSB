...
<form class="layui-form" id="inputForm">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 350px;">
            <input id="productName" name="productName" style="display: inline;width: 190px;" class="layui-input" readonly>
            <input type="hidden" id="productId" name="product"/>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 300px;">
            <input id="image" name="image" style="display: inline;width: 190px;" class="layui-input">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input name="subscribeHelp" value="true" title="需要" checked type="radio">
                <input name="subscribeHelp" value="false" title="不需要" type="radio">
            </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input id="number" name="number" lay-verify="required" autocomplete="off" class="layui-input" placeholder="请输入整数" />
            </div>
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input id="minPrice" name="minPrice" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">目标金额</label>
            <div class="layui-input-inline">
                <input id="maxPrice" name="maxPrice" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">助力范围</label>
            <div class="layui-input-inline">
                <input id="minAssistancePrice" name="minAssistancePrice" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
            <div class="layui-form-mid">-</div>
            <div class="layui-input-inline">
                <input id="maxAssistancePrice" name="maxAssistancePrice" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
