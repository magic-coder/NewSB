...
<@shiro.hasPermission name = "wxluckdraw:add">
    ...
    <tr>
        ...
        <td>
            ...
            <input style="width: 80px;" id="copy${dto_index}" class="layui-btn layui-btn-normal layui-btn-sm copy"
                   title="${siteUrl}/wxLuckdrawIndex?id=${dto.id!?c}" value="复制链接">
            <input style="width: 80px;" onclick="showqrcode('${siteUrl!}/wxLuckdrawIndex?id=${dto.id!?c}')" class="layui-btn layui-btn-normal layui-btn-sm"
                   value="预览">
            <@shiro.hasPermission name = "wxluckdraw:edit">
            ...
            <@shiro.hasPermission name = "wxluckdraw:delete">
