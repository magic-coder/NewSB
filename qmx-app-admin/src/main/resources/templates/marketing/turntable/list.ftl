    ...
    <tr>
        ...
        <td>
            <input style="width: 80px;" id="copy${dto_index}" class="layui-btn layui-btn-normal layui-btn-sm copy"
                   title="${siteUrl}/wxturntableindex?id=${dto.id!?c}" value="复制链接">
            <input style="width: 80px;" onclick="showqrcode('${siteUrl!}/wxturntableindex?id=${dto.id!?c}')" class="layui-btn layui-btn-normal layui-btn-sm"
                    value="预览">
