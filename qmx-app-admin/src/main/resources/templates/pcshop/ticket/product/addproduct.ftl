...
<body>
<form class="layui-form" action="/pcticket/product/save" method="post">
    ...
    <div class="layui-form-item">
        ...
        <input type="hidden" name="sightId" id="sightId"/>
    ...
    <div class="layui-form-item">
        <div class="layui-inline" style="width: 700px;">
            ...
            <div class="layui-input-block">
                ...
                <img class="imageStyleImg" alt="" height="151" width="171" style="border: solid"/>
