...
<body>
<form id="imgForm" class="layui-form" method="post" name="imgForm" action="save">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="groupNumber" lay-verify="groupNumber" autocomplete="off"  class="layui-input"/>
            </div>
        </div>
    </div>
    <div class="layui-form-item">
