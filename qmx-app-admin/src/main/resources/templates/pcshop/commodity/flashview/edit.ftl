...
<form class="layui-form" action="update" method="post">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="hidden" name="imgurl" lay-verify="imgurl" autocomplete="off" class="layui-input"
                       value="${dto.imgurl}">
                <img src="${dto.imgurl}" class="imageStyleImg" alt="" height="100" width="450" style="border: solid"/>
                <button type="button" class="layui-btn test1">
                    <i class="layui-icon">&#xe67c;</i>上传图片
                </button>
                <li style="color: red">(请上传9:2大小的图片例如：1440px*320px)</li>
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input name="serial" lay-verify="serial" autocomplete="off" class="layui-input" value="${dto.serial!}">
            </div>
        </div>
    </div>
