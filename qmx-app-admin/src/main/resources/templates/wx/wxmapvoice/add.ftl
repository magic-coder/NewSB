...
<form class="layui-form" action="save" method="post">
    ...
    <div class="layui-form-item">
        <div class="layui-inline" style="width: 100%;">
            ...
            <div class="layui-input-inline" style="width: 80%;">
                <input id="name" name="name" style="display: inline;width: 190px;" placeholder="景区名称" lay-verify="required" autocomplete="off" class="layui-input">
    ...
    <script>
        ...
        var init = function() {
            ...
            var groundOverlay = new qq.maps.GroundOverlay({
                ...
                map: map,
                //设置图片地址
                imageUrl: '${base}/bak/images/test_wxmapvoice.jpg',
                //设置覆盖层的透明度
                opacity:0.7,
                //设置地面覆盖层可响应鼠标事件，默认为true
                clickable: true,
            });
            var sw = new qq.maps.LatLng(30.643786087,104.0449548098);//西南角坐标
            var ne = new qq.maps.LatLng(30.648811864,104.0504276633);//东北角坐标
