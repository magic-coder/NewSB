...
<form class="layui-form" action="update" method="post">
    ...
    <div class="layui-form-item">
        <div class="layui-inline" style="width: 100%;">
            ...
            <div class="layui-input-inline" style="width: 30%;">
                <select id="type" name="type" onchange="javascript:typechange();">
                <#list types as type>
                    <option value="${type}" <#if dto.type == "${type!}">selected</#if>>${(type.title)!}</option>
                </#list>
                </select>
            </div>
        </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline" style="width: 100%;">
            ...
            <div class="layui-input-inline" style="width: 30%;">
                <label><input type="radio" name="state" value="1" title="是"<#if dto.state==true>checked</#if>/></label>
                <label><input type="radio" name="state" value="0" title="否"<#if dto.state==false>checked</#if>/></label>
            </div>
            <label class="layui-form-label" style="width: 120px;">是否使用微信模板:</label>
            <div class="layui-input-inline" style="width: 30%;">
                <label><input type="radio" name="enable" value="1" title="是"
                              <#if dto.enable==true>checked</#if>/></label>
                <label><input type="radio" name="enable" value="0" title="否"
                              <#if dto.enable==false>checked</#if>/></label>
    ...
    <div class="layui-form-item">
        <div class="layui-inline" style="width: 100%;">
            ...
            <div class="layui-input-inline" style="width: 30%;">
                <input id="templateid" name="templateId" value="${dto.templateId!}"
                       style="display: inline;width: 190px;" lay-verify="required" autocomplete="off"
                       class="layui-input">
            </div>
            <label class="layui-form-label" style="width: 120px;">模板消息内容:</label>
            <div class="layui-input-inline" style="width: 30%;">
                <textarea id="content" class="layui-textarea" name="content"
                          style="display: inline;">${(dto.content)!}</textarea>
