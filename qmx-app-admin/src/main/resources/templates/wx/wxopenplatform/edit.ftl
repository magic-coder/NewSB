...
<form id="inputForm" action="update.jhtml" method="post">
    ...
    <table class="input tabContent">
        <tr>
            ...
            <td>
                <input type="text" name="authorizerAppid" class="text" maxlength="20" value="${dto.authorizerAppid!}" />
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="text" name="nickName" class="text" maxlength="20" value="${dto.nickName!}"/>
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="text" name="headImg" class="text" maxlength="20" value="${dto.headImg!}"/>
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="text" name="qrcodeUrl" class="text" maxlength="20" value="${dto.qrcodeUrl!}"/>
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="text" name="userName" class="text" maxlength="20" value="${dto.userName!}"/>
            </td>
        </tr>
        <!--
        <tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="outappkey" class="text" maxlength="20" value="${dto.outappkey!}"/>
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input type="text" name="secretKey" class="text" maxlength="20" value="${dto.secretKey!}"/>
            </td>
        </tr>
        <!--
        <tr>
