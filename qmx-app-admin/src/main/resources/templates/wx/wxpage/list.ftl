...
<#list page.records as dto>
    <tr>
        ...
        <td>
            <input type="button" title="${siteUrl!}/wxpage?id=${dto.id!?c}" id="copy${dto.id!?c}" class="layui-btn layui-btn-normal layui-btn-sm copy bor_grey"
                   value="复制链接"/>
            <input type="button" onclick="showqrcode('${siteUrl!}/wxpage?id=${dto.id!?c}')" class="layui-btn layui-btn-normal layui-btn-sm"
                   value="预览"/>
        </td>
        <td>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $("a.copy").each(function(){
            var Zero = ZeroClipboard;
            Zero.moviePath = "${base}/js/ZeroClipboard/ZeroClipboard.swf";
