...
<div class="layui-form-item">
    &nbsp;
<@shiro.hasPermission name = "ttproductrule:add">
    <div class="layui-inline">
        <div class="layui-input-inline">
...
<table class="layui-table" style="width:98%;margin-left: 10px;margin-top: 10px;margin-right: 10px;" id="sysBalanceTable"
    ...
    <tr>
        ...
        <td>${dto.name!}</td>
        <td>
            <span title="${dto.productName}">${dto.productName}</span>(${dto.productId})
        </td>
        <td>
        ${dto.type.title!}
        </td>
        ...
        <td>
            <@shiro.hasPermission name = "ttproductrule:edit">
            ...
            <@shiro.hasPermission name = "ttproductrule:delete">
