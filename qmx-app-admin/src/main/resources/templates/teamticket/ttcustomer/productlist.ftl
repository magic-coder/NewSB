...
<#include "/include/common_header_include.ftl">
    <script>
        ...
        function addProductItem(data) {
            ...
            var $tr = '<tr>' +
                    '<td>' +
                    '<input type="hidden" name="cpid" class="cpid" value="">' +
                    '<input type="hidden" name="productId" class="productId" value="' + data.id + '">' + data.name + '</td>' +
                    '<td><input name="price" class="layui-input" lay-verify="required" placeholder="不能低于授权价' + data.marketPrice +'"></td>' +
                    /*'<td><input name="size" class="layui-input" lay-verify="required" placeholder="大于'+data.size+'"></td>' +*/
