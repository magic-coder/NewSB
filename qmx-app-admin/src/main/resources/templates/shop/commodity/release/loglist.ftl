...
<#--<div class="layui-form-item">
    ...
    <div class="layui-inline">
        <div class="layui-input-inline">
            <button onclick="window.location.href='/commodityRelease/addRelease?groupId=${groupId!}'"
                    class="layui-btn layui-btn-normal">发布商品
            </button>
        </div>
        <div class="layui-input-inline">
            <button onclick="putAway()" class="layui-btn layui-btn-normal">上架</button>
            <button onclick="soldOut()" class="layui-btn layui-btn-normal">下架</button>
        </div>
    </div>
</div>-->
