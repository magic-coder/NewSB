    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="hidden" name="imgurl" id="imgurl" lay-verify="imgurl" autocomplete="off" class="layui-input">
                <img class="imageStyleImg" alt="" height="150" width="300" style="border: solid"/>
