...
<body>
<form class="layui-form" action="/ticket/product/update" method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input name="saleStart" id="saleStart" autocomplete="off"
                   class="layui-input" lay-verify="required" value="${dto.saleStart!}">
        </div>
        <div class="layui-form-mid">至</div>
        <div class="layui-input-inline">
            <input name="saleEnd" id="saleEnd"
                   autocomplete="off" class="layui-input" lay-verify="required" value="${dto.saleEnd!}">
        </div>
    </div>
    ...
    <#--<div class="layui-input-inline" style="width: 50px;">
        <input name="usefulDay" autocomplete="off" class="layui-input" value="${dto.usefulDay!}"
               style="width: 40px;" lay-verify="required">
    </div>-->
