...
<div class="container-fluid">
    ...
    <div class="gds-operation">
        ...
        <@shiro.hasPermission name="createGroup">
            <button type="button" class="btn btn-default gds-btn-1" onclick="location.href='add';">新增门票商城组</button>
        </@shiro.hasPermission>
        ...
        <@shiro.hasPermission name="slideShow">
            <button type="button" class="btn btn-default gds-btn-1" onclick="location.href='/ticket/flashview/list';">
                门票商城轮播设置
            </button>
        </@shiro.hasPermission>
        </div>
            ...
            <div class="panel-heading">
                <div class="panel-title row">
                    ...
                    <div class="col-sm-12 text-right">
                        <@shiro.hasPermission name="createTicket">
                            <a class="btn gds-btn-2" href="/ticket/product/add?groupId=${dto.id?c!}">新增产品</a>
                        </@shiro.hasPermission>
                        ...
                        <@shiro.hasPermission name="copyGropLink">
                        ...
                        <#list dto.products as info>
                            <div class="row">
                                ...
                                <div class="col-sm-8 text-right">
                                    <@shiro.hasPermission name="editTicket">
                                        <a class="gds-fg-blue"
                                           onclick="location.href='/ticket/product/edit?id=${info.id!?c}'">编辑</a>
                                    </@shiro.hasPermission>
                                    <@shiro.hasPermission name="deleteTicket">
                                        <a class="gds-fg-blue" onclick="delProduct('${info.id?c!}')">删除</a>
                                    </@shiro.hasPermission>
                                    <@shiro.hasPermission name="updateTicketStatus">
                                        <a class="gds-fg-blue"
                                           href="/ticket/product/updateStatus?id=${info.id!}"><#if '${info.status!?c}'=='false'>
                                            启用
                                        <#elseif '${info.status!?c}'=='true'>禁用
                                        </#if></a>
                                    </@shiro.hasPermission>
                                    <@shiro.hasPermission name="copyTicketLink">
