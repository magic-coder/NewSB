    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input name="groupId" type="hidden" value="${dto.groupId!}"/>
...
<div class="layui-form-item">
    ...
    <div class="layui-inline">
        <div class="layui-input-inline">
        <@shiro.hasPermission name="qrCreateFlashView">
            <button onclick="location.href='/qrcode/flashview/add?groupId=${dto.groupId!}';"
                    class="layui-btn layui-btn-normal">新增
            </button>
        </@shiro.hasPermission>
        </div>
    </div>
