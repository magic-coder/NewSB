...
<form class="layui-form" action="update" method="post">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input name="carousel" lay-verify="required" autocomplete="off" type="radio"
                       value="true" title="启用" <#if '${dto.carousel!?c}'=='true'>checked</#if>>
                <input name="carousel" lay-verify="required" autocomplete="off" type="radio"
                       value="false" title="禁用" <#if '${dto.carousel!?c}'=='false'>checked</#if>>
            </div>
        </div>
    </div>
    <!--组状态-->
