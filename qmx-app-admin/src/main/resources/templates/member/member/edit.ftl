...
<#--<input type="hidden" name="cardNumber" value="${dto.cardNumber!}"/>-->
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input name="mobile" value="${dto.mobile}" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">身份证号</label>
            <div class="layui-input-inline">
                <input name="idcard" value="${dto.idcard!}" lay-verify="required" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input id="birthday" value="${dto.birthday?datetime!}" name="birthday" lay-verify="required"
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input id="pastTime" value="${dto.pastTime?datetime!}" name="pastTime" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input name="cardNumber" value="${dto.cardNumber!}" lay-verify="required" autocomplete="off"
                       class="layui-input" style="width: 280%">
            </div>
        </div>
    </div>
