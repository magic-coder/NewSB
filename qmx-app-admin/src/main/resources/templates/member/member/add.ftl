...
//
////                        layer.msg("超过500KB会自动压缩");
////                        var a = obj.quality = 0.8;
////                        layer.msg(file.length());
...
<form class="layui-form" id="inputForm" action="save" method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input name="idcard" lay-verify="required|identity" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input name="workUnit" lay-verify="required" autocomplete="off" class="layui-input" style="width: 281%">
            </div>
        </div>
    </div>

    <div class="layui-form-item">
        <label class="layui-form-label">现居住址</label>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input name="address" lay-verify="required" autocomplete="off" class="layui-input" style="width: 280%">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">虚拟卡号</label>
            <div class="layui-input-inline">
                <input name="cardNumber" lay-verify="required" autocomplete="off" class="layui-input"
                       style="width: 280%">
            </div>
        </div>
    </div>
