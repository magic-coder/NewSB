...
<form class="layui-form" id="inputForm" action="save" method="post">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input name="rate" lay-verify="required|number" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="radio" name="superposition" value="1" title="是" checked="">
                <input type="radio" name="superposition" value="0" title="否">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
