...
<form class="layui-form" id="inputForm" action="update" method="post">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <input type="hidden" id="levelName" name="levelName" value="${dto.levelName!}"/>
        ...
        <#--<label style="color: red;">添加产品后，需设置价格政策才会保存产品信息</label>-->
            ...
            <#if menpiao??>
                <#list menpiao as ls>
                    <tr>
                        <td> ${ls.productName!}
                            <input type="hidden" name="ids" value="${ls.productId!}&${ls.productName}&${ls.productType}">
                        </td>
                        <td>
        ...
        <#--<label style="color: red;">添加产品后，需设置价格政策才会保存产品信息</label>-->
            ...
            <#if shangpin??>
                <#list shangpin as sp>
                    <tr>
                        <td> ${sp.productName!}
                            <input type="hidden" name="ids" value="${sp.productId!}&${sp.productName}&${sp.productType}">
                        </td>
                        <td>
                            <input type="button" class="layui-btn layui-btn-sm layui-btn-normal deleteItem"
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">折扣率<span style="color: red;font-weight: bold">1:</span></label>
            <div class="layui-input-inline">
                <input name="rate" value="${dto.rate!}" lay-verify="required|number" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">优惠券叠加</label>
            <div class="layui-input-inline">
                <input type="radio" name="superposition" value="1" title="是" <#if dto.superposition?? && dto.superposition==true>checked</#if>>
                <input type="radio" name="superposition" value="0" title="否" <#if dto.superposition?? && dto.superposition==false>checked</#if>>
            </div>
        </div>
    </div>
    <div class="layui-form-item">
