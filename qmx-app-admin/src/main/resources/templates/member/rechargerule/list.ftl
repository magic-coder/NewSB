...
<form class="layui-form" action="list" method="post">
    <div class="layui-form-item">
        ...
        <#--<option value="section" <#if dto.type?? && dto.type=="section">selected</#if>>区间</option>-->
        <#--<option value="fixed" <#if dto.type?? && dto.type=="fixed">selected</#if> >固定</option>-->
        <#--</select>-->
        <#--</div>-->
        <#--<div class="layui-input-inline">-->
        <#--<select name="give" lay-filter="aihao" lay-verify="required">-->
        <#--<option value="">--赠送类型--</option>-->
        <#--<option value="integral" <#if dto.give?? && dto.give=="integral">selected</#if>>积分</option>-->
        <#--<option value="money" <#if dto.give?? && dto.give=="money">selected</#if>>金额</option>-->
        <#--</select>-->
        <#--</div>-->
        </div>
        <div class="layui-inline">
...
<#list page.records as dto>
    <tr>
        ...
        <td>
            <#list lList as l >
                <#if l.id==dto.levelId>
                    <span title="${l.name}">${l.name}</span><#--(${dto.levelId})-->
                </#if>
            </#list>
        </td>
        <td>
        ...
        <td>
            ...
            <#elseif dto.give=="zhekou">
                <span style="color: red;<#--font-weight: bold"-->">1 : </span>${dto.discountPoint!}
            </#if>
        </td>
        <td>
