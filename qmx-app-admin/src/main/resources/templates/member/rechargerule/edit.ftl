...
<form class="layui-form" id="inputForm" action="update" method="post">
        ...
        <#--<div class="layui-inline">-->
            ...
            <#--<div class="layui-input-inline">-->
                ...
                <#--<#list typeList as type>-->
                    <#--<option value="${type}" <#if dto.rechargeType==type>selected</#if>>${type.title}</option>-->
                <#--</#list>-->
                <#--</select>-->
            <#--</div>-->
        <#--</div>-->
    ...
    <div  id="GDczje" class="layui-form-item" style="<#if dto.type=="section">display: none</#if>">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input id="amount" name="amount" value="${dto.amount!}" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    <div  id="QJczje" class="layui-form-item" style="<#if dto.type=="fixed">display: none</#if>">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input id="minAmount" name="minAmount" value="${dto.minAmount!}" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label"style="text-align: left;">最大充值金额</label>
            <div class="layui-input-inline">
                <input id="maxAmount" name="maxAmount" value="${dto.maxAmount!}" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div id="ZSjf" class="layui-form-item" style="<#if dto.give=="zhekou">display: none</#if>">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input id="integralPoint" name="moneyPoint" value="${dto.moneyPoint!}" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    <div id="ZSje" class="layui-form-item" style="<#if dto.give=="zengsong">display: none</#if>">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input id="moneyPoint" name="discountPoint" value="${dto.discountPoint!}" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input  id="JFBL" placeholder="充100得100积分" value="${dto.integralPoint!}" name="integralPoint" lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
